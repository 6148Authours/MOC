...
class LSTMCell(nn.Module):
    ...
    def forward(self, x, state):
        ...
        h, c = state
        # lstm_vector = F.linear(x, self.linear_ih_weight, self.linear_ih_bias) + F.linear(h, self.linear_hh_weight)
...
class HyperLSTMCell(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, hyper_hidden_size, hyper_embedding_size, use_layer_norm, drop_prob,
        ...
        # self.weight_embeddings = embed_uniform(torch.zeros(self.num_kernels, hidden_size))
    ...
    def forward(self,
        ...
        # if read_mem:
        #     # Todo: read from the memory
        #     self.external_mem = mems
