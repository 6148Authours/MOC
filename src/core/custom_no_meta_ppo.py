...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        # Logs
        self.tensor_log.add_scalar('losses/policy_loss', policy_loss, self.train_time)
        self.tensor_log.add_scalar('losses/entropy_loss', entropy_loss, self.train_time)
        self.tensor_log.add_scalar('losses/value_loss', value_loss, self.train_time)
